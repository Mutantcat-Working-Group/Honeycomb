;=== [可配置区域] ============================================
; 命令行参数覆盖示例:
;   makensis.exe /DVERSION=1.1.20260818 /DSTAGING=E:\Projects\Honeycomb_1.1.20260818_msvc2022_64 Honeycomb.nsi
!ifndef VERSION
  !define VERSION "1.1.20260818"
!endif
!ifndef STAGING_DIR
  !define STAGING_DIR "E:\Projects\Honeycomb_1.1.20260818_msvc2022_64"
!endif
