function getEnLang() {
    return {
        ...
        toolFileBase64: "File to Base64",
        toolFileBase64Desc: "Drop a file and convert it to Base64",
        toolBase64ImagePreview: "Base64 Image Preview",
        toolBase64ImagePreviewDesc: "Preview image from Base64 text",
        toolImageCompress: "Image Compress",
        toolImageCompressDesc: "Compress images with more formats and size limits",
        fileBase64DropTip: "Drop to convert to Base64",
        fileBase64LimitTip: "To avoid freezes, single file size limit:",
        fileBase64Result: "Base64 Result",
        fileBase64ResultPlaceholder: "Base64 text will appear after conversion",
        imageQualityTiny: "Maximum Compression",
        imageQualityLow: "Low Quality",
        imageQualityMedium: "Medium Quality",
        imageQualityBalanced: "Balanced",
        imageQualityHigh: "High Quality",
        imageQualityVeryHigh: "Very High Quality",
        imageQualityOriginal: "Near Original",
        imageSizeOriginal: "Keep Original Size",
        imageCompressDropTip: "Drop to fill image path",
        imagePathPlaceholder: "Enter full image path, or drop an image...",
        imageOutputFormat: "Output Format",
        imageQualityLevel: "Compression Level",
        imageMaxSize: "Max Edge",
        imageOutputPath: "Output Path",
        imageOutputPathPlaceholder: "Leave empty to auto-generate",
        imageCompressResult: "Compression Result",
        imageCompressResultPlaceholder: "Output file and size changes will appear after compression",
        imageOriginalSize: "Original Size",
        imageCompressedSize: "Compressed",
        imageSaved: "Saved",
        imageFormatTip: "Read formats",
        ...
        toolUtf8: "UTF-8 Converter",
        toolUtf8Desc: "Text and UTF-8 percent encoding",
        utf8Text: "UTF-8 Encoding",
        utf8PlaceholderText: "Enter Chinese or other text here...",
        utf8PlaceholderCode: "Enter UTF-8 encoding here...",
        toUtf8: "To UTF8",
        fromUtf8: "To Text",
        ...
        toolEnvironmentPath: "PATH Viewer",
        toolEnvironmentPathDesc: "Cross-platform PATH environment viewer",
        toolDocker: "Docker Tools",
        toolDockerDesc: "Docker command cheatsheet and Compose converter",
        toolDockerCheatsheet: "Docker Commands",
        toolDockerCheatsheetDesc: "Common Docker command reference",
        toolDockerCompose: "Docker Compose Convert",
        toolDockerComposeDesc: "Convert docker run and Compose",
        toolSqlFormat: "SQL Formatter",
        toolSqlFormatDesc: "Format and compress SQL",
        toolLddQuick: "Quick LDD",
        toolLddQuickDesc: "Linux/macOS dependency commands",
        toolProcessManager: "Process Manager",
        toolProcessManagerDesc: "View processes and terminate selected process",
        toolPortManager: "Port Manager",
        toolPortManagerDesc: "View port usage and release occupied ports",
        processSearchPlaceholder: "Filter by PID, process name, or user...",
        processName: "Process",
        processUser: "User",
        killProcess: "Kill",
        killPort: "Release Port",
        portInputPlaceholder: "Enter port, e.g. 8080; leave empty to show all listening ports",
        portLabel: "Port",
        listenAddress: "Listen Address",
        envPathPlatform: "System",
        envPathSeparator: "Separator",
        envPathTotal: "Total",
        envPathExisting: "Existing",
        envPathMissing: "Missing",
        envPathDuplicate: "Duplicate",
        envPathRaw: "Raw PATH",
        envPathList: "PATH List",
        envPathStatus: "Status",
        envPathDuplicateShort: "Duplicate",
        envPathMissingShort: "Missing",
        envPathOk: "OK",
        envPathCopyLines: "Copy Lines",
        envPathCommandRef: "Command Reference",
        envPathAddPlaceholder: "Enter directory to add...",
        envPathCopyCommand: "Copy Command",
        envPathCopyClean: "Copy Clean PATH",
        envPathTip: "Tip: The app reads the current process environment. Restart the app after changing system PATH to see the latest value.",
        ...
        toolFileChecksum: "File Checksum",
        toolFileChecksumDesc: "Calculate multiple file hashes at once",
        fileChecksumDropTip: "Drop to calculate all hashes",
        fileChecksumResult: "Checksum Result",
        fileChecksumPending: "Waiting for calculation",
        fileChecksumComparePlaceholder: "Paste expected value to compare",
        fileChecksumCompareTip: "Compare automatically after input",
        fileChecksumMatch: "Match",
        fileChecksumMismatch: "Mismatch",
        toolFileMd5: "File MD5",
        toolFileMd5Desc: "Drop file to calculate MD5",
        toolFileSha1: "File SHA1",
        toolFileSha1Desc: "Drop file to calculate SHA1",
        toolFileSha256: "File SHA256",
        toolFileSha256Desc: "Drop file to calculate SHA256",
        toolFileInfo: "File Info",
        toolFileInfoDesc: "View file metadata and hashes",
        fileHash: "File Hash",
        fileHashDesc: "Drop a file or enter path to calculate file hash",
        filePath: "File Path",
        filePathPlaceholder: "Enter full file path, or drop a file...",
        fileHashDropTip: "Drop to calculate file hash",
        fileHashResultPlaceholder: "Drop a file or click calculate to show result",
        toolSha1: "SHA1 Hash",
        ...
        toolSerialPort: "Serial Monitor",
        toolSerialPortDesc: "Serial device send/receive debug",
        serialConnSettings: "Connection",
        serialPort: "Port:",
        ...
        serialOpen: "Open",
        serialClose: "Close",
        serialReceiveArea: "Received:",
        serialSendArea: "Send:",
        serialTimestamp: "Timestamp",
        serialClearLog: "Clear",
        serialNoData: "No data",
        serialSend: "Send",
        serialAutoSend: "Auto send",
        serialAppendNewline: "Append newline",
        serialHexHint: "Enter hex, e.g. 01 02 AB FF",
        serialTextHint: "Enter text to send",
        ...
        toolWebInspector: "Web Element Picker",
        toolWebInspectorDesc: "Pick web elements and copy info",
        toolWindowInspector: "Window Element Picker",
        toolWindowInspectorDesc: "Pick native window elements and generate AI prompt",
        webInspectorUrlPlaceholder: "Type a URL and press Enter (e.g. localhost:80)",
        webInspectorGo: "Go",
        webInspectorPick: "Pick Element",
        webInspectorPicking: "Picking",
        webInspectorPanelTitle: "Element Info",
        webInspectorEmptyTitle: "No Element Picked",
        webInspectorCopy: "Copy",
        webInspectorClear: "Clear",
        webInspectorCopied: "Element info copied to clipboard",
        webInspectorHttpAuth: "Authentication Required",
        webInspectorProxyAuth: "Proxy Authentication Required",
        webInspectorHttpAuthDesc: "Please enter your username and password for this site:",
        webInspectorProxyAuthDesc: "Please enter your username and password for the proxy server:",
        webInspectorAuthUrl: "URL",
        webInspectorProxyHost: "Proxy Server",
        webInspectorAuthRealm: "Realm",
        webInspectorAuthUser: "Username",
        webInspectorAuthPass: "Password",
        webInspectorAuthCancel: "Cancel",
        webInspectorAuthLogin: "Log In",
        webInspectorPanelHint: "Click \"Pick Element\" in the top-right, hover over any element to highlight it, then click to copy its full info (tag, definition, all attributes, computed styles, XPath, CSS selector, HTML, etc.).",
        ...
        agentPreviewNormal: "Edit",
        agentPreviewMarkdown: "MD Preview",
        agentSpecCheatsheet: "📋 Spec Cheatsheet",
        agentSpecCheatsheetTitle: "Spec Cheatsheet - OpenSpec Workflow",
        agentSpecStepExplore: "1. Explore",
        agentSpecStepExploreDesc: "Run /explore to describe the current behavior, constraints, related code, and unknowns before touching anything.",
        agentSpecStepPropose: "2. Propose",
        agentSpecStepProposeDesc: "Run /propose to write a structured change proposal: Why / What / Impact, listing added/changed/removed scope.",
        agentSpecStepApply: "3. Apply",
        agentSpecStepApplyDesc: "Run /apply to implement requirements one by one; tick each Requirement off as it is verified.",
        ...
        contextFloatCut: "Cut",
        contextFloatCopy: "Copy",
        contextFloatPaste: "Paste",
        contextFloatDelete: "Delete",
        contextFloatSelectAll: "Select All",
        ...
        aboutUpdateAvailable: "New version available: {0}",
        aboutCheckFailed: "Unable to check for updates. Please try again later.",
        aboutOpenDownload: "Open Download Page",
        ...
        changelog20260922: "Fixed Update Check and Release Pipeline Defects",
        changelog20260922Desc: "Version comparison now uses the release date, fixing false prompts for older builds; unified CI asset naming with checksum guards; version comes from a single CMake source; Windows installer defaults are repo-relative",
        changelog20260920: "Release Pipeline Upgrade",
        changelog20260920Desc: "Unified version 1.0.20260920 with automated Windows/macOS/Linux packaging and release",
        ...
        changelog20260723: "Agent Collaboration Improvements",
        changelog20260723Desc: "Improved compatibility with Spec workflows",
        changelog20260722: "New Component Inspector Tools",
        changelog20260722Desc: "Added Web Component Inspector and Window Component Inspector",
        changelog20260718: "New Tools",
        changelog20260718Desc: "Added batch barcode generation to folder and serial port monitor",
        ...
        changelog20260711Desc: "Handled issues: #31, #32, #33",
        ...
        toolBatchBarcode: "Batch Barcode",
        toolBatchBarcodeDesc: "Generate barcodes for a number range and save to a folder",
        batchBarcodePrefix: "Prefix (optional)",
        batchBarcodeStart: "Start",
        batchBarcodeEnd: "End",
        batchBarcodeOutputDir: "Output folder",
        batchBarcodeSelectDir: "Browse",
        batchBarcodeCountPreview: "Will generate %1 files: %2 ~ %3",
        batchBarcodeStartBtn: "Start",
        batchBarcodeCancelBtn: "Cancel",
        batchBarcodeCompleted: "Done %1/%2, saved to %3",
        batchBarcodeInvalidRange: "Start must be less than or equal to end",
        batchBarcodeInvalidInput: "Please enter valid start and end numbers",
        batchBarcodeInvalidDir: "Output folder is invalid",
        batchBarcodeEmptyHint: "Enter start and end numbers above",
        ...
        winEncryptDropTip: "Drop to fill file path",
        ...
        // Window Element Picker
        windowInspectorStart: "Start Capture",
        windowInspectorPickAnchor: "Pick Anchor",
        windowInspectorCancel: "Cancel",
        windowInspectorHotkey: "Global Hotkey",
        windowInspectorRecordHotkey: "Apply",
        windowInspectorHotkeyReady: "Hotkey enabled",
        windowInspectorHotkeyInactive: "Hotkey inactive",
        windowInspectorDelay: "Start Delay (ms)",
        windowInspectorStatusIdle: "Ready",
        windowInspectorStatusWaiting: "Waiting for capture…",
        windowInspectorStatusPicking: "Click a target component; Esc to cancel",
        windowInspectorStatusCaptured: "Captured",
        windowInspectorStatusDenied: "Accessibility permission not granted",
        windowInspectorStatusWayland: "Wayland detected: global hotkey unavailable",
        ...
        windowInspectorTabJson: "JSON",
        windowInspectorTabScript: "Executable Script",
        windowInspectorRecent: "Recent Captures",
        windowInspectorCopied: "Copied to clipboard",
        windowInspectorTrigger: "Trigger",
        windowInspectorEmpty: "No element picked yet",
        windowInspectorHintNatural: "Feed directly to an AI Agent to describe the user intent",
        windowInspectorHintPath: "Structured path, AI can resolve to a precise locator",
        windowInspectorHintJson: "Full property snapshot for debugging and automation",
        windowInspectorHintScript: "Runnable script generated for the current platform",
        windowInspectorEmptyHint: "Click the target component in pick mode; press Esc to cancel"
    };
}
