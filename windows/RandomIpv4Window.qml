...
Window {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                text: I18n.t("toolRandomIpv4Desc")
                font.pixelSize: 14
                color: "#666666"
                Layout.alignment: Qt.AlignHCenter
            }
                ...
                RowLayout {
                    ...
                    ComboBox {
                        ...
                        model: [
                            ...
                            { text: I18n.t("privateIp") || "私有IP", value: "private" },
                            { text: I18n.t("publicIp") || "公共IP", value: "public" },
                            { text: I18n.t("loopbackIp") || "回环IP", value: "loopback" },
                            { text: I18n.t("multicastIp") || "多播IP", value: "multicast" }
                        ]
                        textRole: "text"
                        valueRole: "value"
