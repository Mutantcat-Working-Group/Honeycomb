    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Button { text: I18n.t("calculateBtn") || "计算"; Layout.preferredWidth: 90; onClicked: loadInfo(pathInput.text) }
                Button { text: I18n.t("copyBtn") || "复制"; Layout.preferredWidth: 80; onClicked: copyToClipboard(infoText()) }
            }
            ...
            ScrollView {
                ...
                ColumnLayout {
                    width: fileInfoWindow.width - 70; spacing: 8
                    Repeater {
                        model: [
