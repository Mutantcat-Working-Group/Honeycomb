...
Window {
    id: mqttPublisherWindow
    width: 750
    height: 700
    title: I18n.t("toolMQTTPublisher") || "MQTT广播"
    flags: Qt.Window
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                text: I18n.t("toolMQTTPublisher") || "MQTT广播"
                font.pixelSize: 22
                font.bold: true
                color: "#333333"
            ...
            Text {
                text: I18n.t("toolMQTTPublisherDesc") || "连接到MQTT Broker并发布消息到指定主题"
                font.pixelSize: 14
                color: "#666666"
                Layout.alignment: Qt.AlignHCenter
            }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: (I18n.t("connectionStatus") || "连接状态:") + " " + mqttPublisher.connectionStatus
                            font.pixelSize: 14
                            font.bold: true
                            color: mqttPublisher.isConnected ? "#27ae60" : "#e74c3c"
                        }
                        ...
                        Button {
                            ...
                            enabled: !mqttPublisher.isConnected
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: I18n.t("publishSettings") || "发布设置"
                        font.pixelSize: 16
                        font.bold: true
                        color: "#333333"
                    }
                    ...
                    RowLayout {
                        ...
                        TextField {
                            ...
                            onTextChanged: {
                                mqttPublisher.message = text
                            }
                            
                            Keys.onReturnPressed: {
                                if (mqttPublisher.isConnected && text.length > 0) {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            onCurrentIndexChanged: {
                                mqttPublisher.qos = currentIndex
                            }
                        }
                        
                        CheckBox {
                            id: retainedCheck
                            text: I18n.t("retainedMessage") || "保留消息"
                            font.pixelSize: 14
                            
                            onCheckedChanged: {
                                mqttPublisher.retained = checked
                            }
                        }
                        ...
                        Button {
                            text: I18n.t("publishBtn") || "发布"
                            Layout.preferredWidth: 80
                            Layout.preferredHeight: 32
                            enabled: mqttPublisher.isConnected && messageInput.text.length > 0
                    ...
                    ScrollView {
                        ...
                        TextArea {
                            ...
                            Text {
                                ...
                                text: I18n.t("noPublishLog") || "暂无发布日志"
                                font.pixelSize: 14
                                color: "#999999"
                                visible: mqttPublisher.messageLog.length === 0
                            }
