...
Window {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                text: "MD5 " + I18n.t("encryptDesc") || "将文本转换为MD5哈希值"
                font.pixelSize: 14
                color: "#666"
                Layout.alignment: Qt.AlignHCenter
            }
                    ...
                    ScrollView {
                        ...
                        TextArea {
                            ...
                            Text {
                                ...
                                text: I18n.t("enterTextToGenerate") || "请输入文本以生成MD5哈希值"
                                font.pixelSize: 14
                                color: "#999"
                                visible: generator.result.length === 0
                            }
