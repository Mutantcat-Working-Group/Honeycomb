...
Window {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                text: "SHA256 " + I18n.t("encryptDesc") || "将文本转换为SHA256哈希值"
                font.pixelSize: 14
                color: "#666"
                Layout.alignment: Qt.AlignHCenter
            }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: "SHA256 " + I18n.t("resultLabel") + ":"
                            font.pixelSize: 14
                            font.bold: true
                            color: "#333"
                        }
                    ...
                    ScrollView {
                        ...
                        TextArea {
                            ...
                            Text {
                                ...
                                text: I18n.t("enterTextToGenerate") || "请输入文本以生成SHA256哈希值"
                                font.pixelSize: 14
                                color: "#999"
                                visible: generator.result.length === 0
                            }
