                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Column {
                                ...
                                Text {
                                    text: I18n.t("changelog20260923") || "修复更新检查与发布流程暗病"
                                    font.pixelSize: 16
                                    font.bold: true
                                    color: "#333"
                                }
                                ...
                                Text {
                                    text: I18n.t("changelog20260923Desc") || "版本比较改为按发布日期判定，修复误报更旧版本；统一 CI 产物命名并增加 checksums 守卫；版本号统一由 CMake 下发；Windows 安装脚本默认路径改为仓库相对路径"
                                    width: parent.width
                                    font.pixelSize: 14
                                    color: "#666"
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Column {
                                ...
                                Text {
                                    text: I18n.t("changelog20260920") || "发布流程升级"
                                    font.pixelSize: 16
                                    font.bold: true
                                    color: "#333"
                                }
                                ...
                                Text {
                                    text: I18n.t("changelog20260920Desc") || "统一版本号 1.0.20260920，新增 Windows/macOS/Linux 三平台自动打包与发布"
                                    width: parent.width
                                    font.pixelSize: 14
                                    color: "#666"
                                    wrapMode: Text.WordWrap
