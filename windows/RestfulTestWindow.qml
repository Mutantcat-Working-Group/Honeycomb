            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    // 响应状态和选项
                                        RowLayout {
                                            ...
                                            ComboBox {
                                                ...
                                                Layout.preferredWidth: 120
                                                model: [
                                                    { text: I18n.t("responseBody") || "响应体", value: "body" },
                                                    { text: I18n.t("responseHeaders") || "响应头", value: "headers" }
                                                ]
                                                textRole: "text"
                                                valueRole: "value"
                                                currentIndex: 0
                                                ...
                                                background: Rectangle {
                                                    color: "white"
                                                    border.color: responseComboBox.focus ? "#1976d2" : "#e0e0e0"
                                                    border.width: responseComboBox.focus ? 2 : 1
                                                    radius: 4
                                                }
                                            }
                    ...
                    Loader {
                        ...
                        sourceComponent: responseComboBox.currentValue === "body" ? bodyComponent : headersComponent
                    }
