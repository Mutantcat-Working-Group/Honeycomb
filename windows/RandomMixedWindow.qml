...
Window {
    id: randomMixedWindow
    width: 500
    height: 450
    title: I18n.t("toolRandomMix")
    flags: Qt.Window
    modality: Qt.NonModal
    
    // C++ 后端实例
    RandomMixedGenerator {
        id: generator
        length: parseInt(lengthInput.text) || 8
        includeUpper: upperCheck.checked
        includeLower: lowerCheck.checked
        includeDigits: digitsCheck.checked
    }
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                CheckBox {
                    id: upperCheck
                    text: I18n.t("includeUpper")
                    checked: true
                }
                
                CheckBox {
                    id: lowerCheck
                    text: I18n.t("includeLower")
                    checked: true
                }
                
                CheckBox {
                    id: digitsCheck
                    text: I18n.t("includeDigits")
                    checked: true
                }
            }
