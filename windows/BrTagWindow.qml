...
Window {
    ...
    minimumWidth: 700
    minimumHeight: 450
    title: I18n.t("toolBrTag")
    flags: Qt.Window
    modality: Qt.NonModal
    
    // 转换模式
    property int convertMode: 0  // 0: 回车转br, 1: br转回车
    ...
    function convertText() {
        ...
        if (convertMode === 0) {
            ...
            // br标签转回车（支持<br>、<br/>、</br>等格式）
            result = input.replace(/<br\s*\/?>/gi, "\n").replace(/<\/br>/gi, "\n")
        }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Column {
                    spacing: 5
                    Text {
                        text: I18n.t("toolBrTag")
                        font.pixelSize: 22
                        font.bold: true
                        color: "#333"
                    }
                    Text {
                        text: I18n.t("toolBrTagDesc")
                        font.pixelSize: 13
                        color: "#666"
                    }
                }
                ...
                Row {
                    ...
                    Button {
                        text: I18n.t("newlineToBr") || "回车转br"
                        width: 100
                        height: 32
                        onClicked: convertMode = 0
                        background: Rectangle {
                            color: convertMode === 0 ? "#0078d4" : "#e0e0e0"
                            radius: 4
                        }
                        contentItem: Text {
                            text: parent.text
                            font.pixelSize: 13
                            color: convertMode === 0 ? "white" : "#333"
                    ...
                    Button {
                        text: I18n.t("brToNewline") || "br转回车"
                        width: 100
                        height: 32
                        onClicked: convertMode = 1
                        background: Rectangle {
                            color: convertMode === 1 ? "#0078d4" : "#e0e0e0"
                            radius: 4
                        }
                        contentItem: Text {
                            text: parent.text
                            font.pixelSize: 13
                            color: convertMode === 1 ? "white" : "#333"
                            horizontalAlignment: Text.AlignHCenter
                            verticalAlignment: Text.AlignVCenter
                        }
                    }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        text: (I18n.t("newlineCount") || "回车数量") + ": " + 
                              (inputArea.text.match(/\r\n|\n|\r/g) ? inputArea.text.match(/\r\n|\n|\r/g).length : 0)
                        font.pixelSize: 13
                        color: "#666"
                    }
                    ...
                    Text {
                        text: (I18n.t("currentMode") || "当前模式") + ": " + 
                              (convertMode === 0 ? (I18n.t("newlineToBr") || "回车转br") :
                                                   (I18n.t("brToNewline") || "br转回车"))
                        font.pixelSize: 13
                        color: "#666"
                    }
                }
