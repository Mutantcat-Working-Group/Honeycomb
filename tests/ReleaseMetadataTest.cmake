...
if(NOT cmake_source MATCHES "project\\(Honeycomb VERSION 1\\.0\\.20260920 ")
    message(FATAL_ERROR "Project version is not 1.0.20260920")
endif()
...
if(NOT nsis_source MATCHES "VERSION=1\\.0\\.20260920" OR
   NOT nsis_source MATCHES "VERSION \"1\\.0\\.20260920\"")
   message(FATAL_ERROR "Windows installer version is not 1.0.20260920")
endif()

foreach(source IN ITEMS changelog_source zh_source en_source)
    if(NOT "${${source}}" MATCHES "20260920")
        message(FATAL_ERROR "${source} does not contain the 20260920 release entry")
    endif()
endforeach()
