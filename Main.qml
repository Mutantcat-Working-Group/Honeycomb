// Honeycomb — 由异猫工作群（mutantcat.org）发行
...
ApplicationWindow {
    ...
    property var windowComponents: ({
        ...
        "Base64图片预览": "qrc:/qt/qml/Honeycomb/windows/Base64ImagePreviewWindow.qml",
        "图片压缩": "qrc:/qt/qml/Honeycomb/windows/ImageCompressWindow.qml",
        ...
        "中文转UTF8": "qrc:/qt/qml/Honeycomb/windows/UTF8Window.qml",
        ...
        "去除分隔空格": "qrc:/qt/qml/Honeycomb/windows/TrimCJKSpaceWindow.qml",
        ...
        "PATH查看器": "qrc:/qt/qml/Honeycomb/windows/EnvironmentPathWindow.qml",
        "Docker命令速查": "qrc:/qt/qml/Honeycomb/windows/DockerToolWindow.qml",
        "Docker Compose转换": "qrc:/qt/qml/Honeycomb/windows/DockerToolWindow.qml",
        "SQL格式化": "qrc:/qt/qml/Honeycomb/windows/SqlFormatWindow.qml",
        "快捷LDD": "qrc:/qt/qml/Honeycomb/windows/LddQuickWindow.qml",
        "进程管理": "qrc:/qt/qml/Honeycomb/windows/ProcessManagerWindow.qml",
        "端口管理": "qrc:/qt/qml/Honeycomb/windows/PortManagerWindow.qml",
        ...
        "Cron表达式解析": "qrc:/qt/qml/Honeycomb/windows/CronParserWindow.qml",
        ...
        "文件校验": "qrc:/qt/qml/Honeycomb/windows/FileChecksumWindow.qml",
        "文件MD5": "qrc:/qt/qml/Honeycomb/windows/FileMD5Window.qml",
        "文件SHA1": "qrc:/qt/qml/Honeycomb/windows/FileSHA1Window.qml",
        "文件SHA256": "qrc:/qt/qml/Honeycomb/windows/FileSHA256Window.qml",
        "文件信息查看": "qrc:/qt/qml/Honeycomb/windows/FileInfoWindow.qml",
        ...
        "DNS查询": "qrc:/qt/qml/Honeycomb/windows/DNSLookupWindow.qml",
    ...
    function getToolsData() {
        ...
        1: [ // 编码工具
            ...
            {title: I18n.t("toolBase64ImagePreview"), subtitle: I18n.t("toolBase64ImagePreviewDesc"), key: "Base64图片预览"},
            {title: I18n.t("toolImageCompress"), subtitle: I18n.t("toolImageCompressDesc"), key: "图片压缩"},
            ...
            {title: I18n.t("toolUtf8"), subtitle: I18n.t("toolUtf8Desc"), key: "中文转UTF8"},
        ...
        2: [ // 字符工具
            ...
            {title: I18n.t("toolTrimCJKSpace"), subtitle: I18n.t("toolTrimCJKSpaceDesc"), key: "去除分隔空格"},
        ...
        3: [ // 开发工具
            ...
            {title: I18n.t("toolEnvironmentPath"), subtitle: I18n.t("toolEnvironmentPathDesc"), key: "PATH查看器"},
            {title: I18n.t("toolDockerCheatsheet"), subtitle: I18n.t("toolDockerCheatsheetDesc"), key: "Docker命令速查"},
            {title: I18n.t("toolDockerCompose"), subtitle: I18n.t("toolDockerComposeDesc"), key: "Docker Compose转换"},
            {title: I18n.t("toolSqlFormat"), subtitle: I18n.t("toolSqlFormatDesc"), key: "SQL格式化"},
            {title: I18n.t("toolLddQuick"), subtitle: I18n.t("toolLddQuickDesc"), key: "快捷LDD"},
            {title: I18n.t("toolProcessManager"), subtitle: I18n.t("toolProcessManagerDesc"), key: "进程管理"},
            {title: I18n.t("toolPortManager"), subtitle: I18n.t("toolPortManagerDesc"), key: "端口管理"},
            ...
            {title: I18n.t("toolCronParser"), subtitle: I18n.t("toolCronParserDesc"), key: "Cron表达式解析"},
        ...
        4: [ // 加密工具
            ...
            {title: I18n.t("toolFileChecksum"), subtitle: I18n.t("toolFileChecksumDesc"), key: "文件校验"},
            {title: I18n.t("toolFileMd5"), subtitle: I18n.t("toolFileMd5Desc"), key: "文件MD5"},
            {title: I18n.t("toolFileSha1"), subtitle: I18n.t("toolFileSha1Desc"), key: "文件SHA1"},
            {title: I18n.t("toolFileSha256"), subtitle: I18n.t("toolFileSha256Desc"), key: "文件SHA256"},
            {title: I18n.t("toolFileInfo"), subtitle: I18n.t("toolFileInfoDesc"), key: "文件信息查看"},
        ...
        6: [ // 网络工具
            ...
            {title: I18n.t("toolDNSLookup"), subtitle: I18n.t("toolDNSLookupDesc"), key: "DNS查询"},
